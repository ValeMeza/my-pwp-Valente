...
<header><h1>Potential Employer</h1> Persona</header>
    ...
    <main><h2>Example Employer</h2>
        <ul>
            ...
            <li>Goals for user base: Will be abel to arrive on my personal website and see examples of my work, how to reach me, get to my github to check recent work and see a about me. Reduce clutter while keeping attention. Keep in mind for mobile use and stay away from making the entire site links to other sites add work on page itself keeping clutter away from the first displayed page. Give the user natural progression from a bio, to work done, to contact info.  </li>
        </ul>
        <h2>Use Case:</h2>
